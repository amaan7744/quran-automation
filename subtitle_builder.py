...
EN_MAX_LINES = 2
EN_WRAP_SAFETY = 0.90
# Sizes increased slightly so the translation is comfortably readable
# while remaining clearly secondary to the (larger) Arabic above it.
EN_MIN_FONT_SIZE = 46  # floor — never too small to read on a phone
EN_MAX_FONT_SIZE = 70  # ceiling for short translation chunks
